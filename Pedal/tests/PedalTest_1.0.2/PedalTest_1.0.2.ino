...
#include "C:\Users\AVG\Documents\Electrical Main (Amir)\Arduino\Projects\WordOfLife\core\LedMacros\SequenceBuild\SequenceBuild_1.0.1.h"
...
// set up neoPixels:
uint8_t pixelBuffer[12];                        // buffer must be double the amount of pixelsChannels(6*)
NeoPixelDriver pixelDriver(12, pixelBuffer, 6); //  set (pinNumber, buffer, numberOfpixelsChannels)
...
// 6 pixel channels even though the last three will be mirrored with the first three
// simpler to create three vars, for later:
// uint8_t green = 0;
// uint8_t red = 0;
// uint8_t blue = 0;
