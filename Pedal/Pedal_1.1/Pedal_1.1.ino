...
SequenceBuild redBuild;   // for all red led's
SequenceBuild greenBuild; // for all green led's
SequenceBuild blueBuild;  // for all blue led's
...
SB_FUNCT(setDefault, allLedReady())
...
// SB_FUNCT(redFade, macro.ready(pedal_R) && macro.ready(tally_R)))
// SB_STEP
// SB_END

// SB_FUNCT(greenFade, macro.ready(pedal_G) && macro.ready(tally_G)))
// SB_STEP
// SB_END

// SB_FUNCT(blueFade, macro.ready(pedal_B) && macro.ready(tally_B)))
// SB_STEP
// SB_END