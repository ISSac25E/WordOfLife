...
/*
  changes
    ...
    - fixed return non void function("deviceConnected")
*/
...
#include "Arduino.h"
#include "other\DeviceBuffer_1.0.0.h"
#include "other\OneWire_Driver_1.0.0.h"
#include "other\BoolConverter_1.0.0.h"
